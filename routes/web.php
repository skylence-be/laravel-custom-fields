...
Route::prefix(config('custom-fields.route.prefix', 'admin/fields'))
    ->middleware(config('custom-fields.route.middleware', ['web', 'auth']))
    ->name(config('custom-fields.route.name_prefix', 'custom-fields.'))
    ->group(function () {
